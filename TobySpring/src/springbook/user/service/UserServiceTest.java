...
import static springbook.user.service.UserServiceImpl.MIN_RECCOMMEND_FOR_GOLD;
...
public class UserServiceTest {
	...
	public void setUp() {
		users = Arrays.asList(
				...
				new User("erwins", "신승한", "p3", "user3@ksug.org", Level.SILVER, 60, MIN_RECCOMMEND_FOR_GOLD-1),
				new User("madnite1", "이상호", "p4", "user4@ksug.org", Level.SILVER, 60, MIN_RECCOMMEND_FOR_GOLD),
